        ...
        <div className="min-h-screen py-8">
          <div className="max-w-6xl">
            ...
            <div className="space-y-6">
              {/* Proposal Card */}
              <Card className="shadow-lg border border-yellow-400 bg-yellow-50">
  <img src={images.propose} alt="Proposal" className="w-full h-[290px] object-contain rounded-t-lg" />
  <div className="p-6">
    <div className="flex justify-between items-start mb-4">
      ...
      <Badge variant="warning" className="bg-yellow-500 text-white">Important Update</Badge>
    </div>
    ...
    <div className="prose text-gray-600">
      ...
      <button className="inline-flex items-center px-4 py-2 border bg-blue-50 cursor-pointer border-blue-600 text-blue-600 rounded-md hover:bg-blue-600 hover:text-white transition-colors">
...
<Card className="shadow-lg border border-yellow-400 bg-yellow-50">
  <img src={images.program} alt="Research Program" className="w-full h-[220px] object-contain rounded-t-lg" />
  <div className="p-6">
    <div className="flex justify-between items-start mb-4">
      <div>
      ...
      <Badge variant="success" className="bg-green-500 text-white">New Winners</Badge>
    </div>
