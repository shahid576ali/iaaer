      ...
      <div className="flex space-x-1 rounded-xl bg-gray-200 p-1 mb-8 mt-6">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <ul className='list-disc list-inside'>
                    <li><a className='text-blue-500 cursor-pointer'>Announcement: Research Grant Recipients</a></li>
                    <li><a className='text-blue-500 cursor-pointer'>Original Call for Proposals </a></li>
                    <li><a className='text-blue-500 cursor-pointer'>News release</a></li>
                </ul>
                <br></br>
                ...
                <ul className='list-disc list-inside'>
                  <li><a className='text-blue-500 cursor-pointer'>Summary of Research findings</a></li>
                </ul>
                <br></br>
                ...
                <br></br>
                <p>The first project is "<a className='text-blue-600 cursor-pointer'>How Does the Methodology of Education and Training in Ethics Affect the Ethical Awareness and Practice of the Professional Accountant?</a>" Principal investigator <strong>F. Greg Barton</strong> leads a team from <strong>Brigham Young University</strong> (USA),
                ...
                <br></br>
                <p><strong>Paul de Lange</strong> and a team from <strong>RMIT University</strong> (Australia) and <strong>Singapore Management University</strong> will investigate continuing professional development (CPD) programs in their project "<a className='text-blue-600 cursor-pointer'>Access to CPD Opportunities and Resources to Assist Professional Accountants to Meet Their Commitment to Life Long Learning:
                ...
                <br></br>
                <p>A team from <strong>Robert Gordon University</strong> (Scotland), headed by <strong>Elizabeth Gammie</strong>, will examine non-technical skills needed by accountants in their project "<a className='text-blue-600 cursor-pointer'>Searching for Best Practice in the Development and Assessment of Non-Technical Skills in Accountancy Trainees – A Global Study</a>." The need for non-technical
                ...
                <br></br>
                <p>The final team is headed by <strong>Christine Helliar</strong> of the <strong>University of Dundee</strong> (UK) and has members from her university, <strong>Brescia University</strong> (Italy), and <strong>Uganda Martyrs University</strong>.  The project, "<a className='text-blue-600 cursor-pointer'>The Awareness and Impact of International Accounting Education Standards</a>," will address the extent
        ...
        {activeTab === "Round 2" && (
          <div className="space-y-8">
            ...
            <br></br>
            <p><a className='text-blue-600 cursor-pointer'>Developing a Global Model of Accounting Education and Examining IES Compliance in Australia, Japan, and Sri Lanka</a></p>
            ...
            <br></br>
            <p><a className='text-blue-600 cursor-pointer'>A Framework of Best Practice of Continuing Professional Development for the Accounting Profession</a></p>
